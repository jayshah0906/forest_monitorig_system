...
function displayResults(data) {
    ...
    // Update KPIs
    document.getElementById('tree-count').textContent = kpis.tree_count.toLocaleString();
    document.getElementById('area').textContent = kpis.area_hectares.toFixed(2);
    document.getElementById('density').textContent = kpis.tree_density.toFixed(2);
    document.getElementById('health-score').textContent = `${kpis.health_score}/100`;
